  ...
  rules: [
    {
      ...
      note: 'Переделали первый экран и приглашение участников. Через месяц ' +
        'когорта новичков впервые за квартал дожила до второй недели ' +
        'в полном составе. Поддержка перестала отвечать одной и той же ' +
        'инструкцией по двадцать раз в день.'
    },
    {
      action: 'a_fix_onboarding', unlessTruth: 'h1', effects: [],
      note: 'Онбординг переделан. Отток остался прежним: уходили не новички ' +
        'и не из-за первого экрана.'
    },
    {
      ...
      note: 'Откатили релиз — и отток просел уже через три недели, быстрее, чем ' +
        'дала бы починка. Но вернулся и старый экран со всеми его болячками, ' +
        'и через месяц часть проблемы приползла обратно.'
    },
    {
      action: 'a_rollback', unlessTruth: 'h1',
      effects: [{ metric: 'nps_segment', delta: -3, afterWeeks: 3 }],
      note: 'Откатили релиз. Те, кто успел привыкнуть к новому, написали гневно. ' +
        'На отток это не повлияло.'
    },
    {
      action: 'a_support_staff',
      effects: [{ metric: 'response_hours', delta: -0.6, afterWeeks: 2 }],
      note: 'Двоих отправили в поддержку. Там и без них справлялись — ' +
        'время ответа сдвинулось на пару минут, и всё.'
    },
    {
      action: 'a_discount',
      effects: [
      ...
      note: 'Скидка придержала уходящих на месяц. Потом они ушли всё равно, ' +
        'а выручка осталась урезанной.'
    },
    {
      action: 'a_outreach',
      effects: [
      ...
      note: 'Обзвонили группу риска. Часть уговорили остаться — но ровно на то ' +
        'время, пока кто-то звонил. Потом они ушли следом за остальными.'
    }
  ],
