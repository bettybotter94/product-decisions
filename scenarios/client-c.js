  ...
  rules: [
    {
      ...
      note: 'Честные даты и предупреждение заранее сняли настоящую претензию. Выгрузку так и не сделали — и оказалось, что она была не главным.'
    },
    {
      action: 'a_roadmap', unlessTruth: 'h4',
      effects: [{ metric: 'relationship', delta: 5, afterWeeks: 2 }],
      note: 'Дорожная карта воспринята вежливо, но просили не её.'
    },
    {
      action: 'a_meet_dm',
      effects: [{ metric: 'relationship', delta: 7, afterWeeks: 1 }],
      note: 'Встреча прояснила картину и немного улучшила отношения, но сама по себе ничего не изменила.'
    },
    {
      ...
      note: 'Срез сделали к обещанной дате — и это заметили больше, чем сам срез.'
    },
    {
      action: 'a_build_full',
      effects: [
      ...
      note: 'Полная доработка съела квартальную цель и заняла шесть недель — на две больше обещанного. Претензия к срокам только подтвердилась.'
    },
    {
      ...
      note: 'Скидка обошлась в часть выручки. Про деньги речи и не шло.'
    },
    {
      action: 'a_formal_reply',
      effects: [{ metric: 'relationship', delta: -8, afterWeeks: 4 }],
      note: 'Ответ «принято в бэклог» от тех, кто четыре раза сдвигал даты, прочитали ровно так, как он написан.'
    }
  ],
