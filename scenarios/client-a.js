  ...
  rules: [
    {
      ...
      note: 'Съездили. Директор по операциям выслушал, посмотрел письмо и сказал: ' +
        '«Я не знал, что он так написал». Угроза растворилась за час разговора. ' +
        'Команду с квартальной цели снимать не пришлось вообще.'
    },
    {
      action: 'a_meet_dm', unlessTruth: 'h2',
      effects: [{ metric: 'relationship', delta: 7, afterWeeks: 1 }],
      note: 'Съездили, поговорили по-человечески. Отношения потеплели, но то, ' +
        'из-за чего всё началось, осталось на месте.'
    },
    {
      ...
      note: 'Срез сделали за две недели. Сергей прислал скриншот выгрузки ' +
        'с подписью «наконец-то». Квартальную цель это почти не задело.'
    },
    {
      action: 'a_build_full',
      effects: [
      ...
      note: 'Шесть недель команда делала выгрузку. Клиент доволен и остался — ' +
        'правда, он и не собирался уходить. Квартальная цель не закрыта, ' +
        'и на ревью объяснять это пришлось тебе.'
    },
    {
      ...
      note: 'Предложили скидку. Ответили вежливо и недоумённо: денег никто ' +
        'и не просил. Выручка просела, вопрос остался.'
    },
    {
      action: 'a_formal_reply', ifTruth: 'h1',
      effects: [{ metric: 'revenue_anchor', delta: -1.80, afterWeeks: 6 }],
      note: 'Ответили, что запрос принят в бэклог. Через четыре месяца пришло ' +
        'уведомление о непродлении — ровно в тот срок, о котором предупреждали.'
    },
    {
      action: 'a_formal_reply', unlessTruth: 'h1',
      effects: [{ metric: 'relationship', delta: -7, afterWeeks: 4 }],
      note: 'Ответили в бэклог. Никто не ушёл, но осадок остался: ' +
        'следующее письмо пришло уже суше.'
    }
  ],
