  ...
  rules: [
    {
      ...
      note: 'Скидка сработала: уходили действительно из-за цены. Но выручка срезана на всё время действия скидки — бесплатных решений тут не было.'
    },
    {
      ...
      note: 'Скидка придержала уходящих и срезала выручку, причину не тронула.'
    },
    {
      ...
      note: 'Личный разговор удержал часть уходящих к конкуренту — но только тех, до кого дошли руки.'
    },
    {
    ...
    },
    {
      ...
      note: 'Онбординг переделан. Уходили не новички и не из-за него.'
    },
    {
      action: 'a_rollback',
      effects: [{ metric: 'nps_segment', delta: -3, afterWeeks: 3 }],
      note: 'Откат мелкого релиза раздражил людей и не тронул причину.'
    }
  ],
