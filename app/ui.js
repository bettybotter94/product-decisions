...
function recordRun(d) {
  ...
  save();
  // Прогон попадает в историю уже после того, как построен ряд вкладок.
  // Без этой перерисовки «Прогресс» и «Сравнить» появятся только после
  // следующего клика — выглядит так, будто их нет.
